...
public class BasicMessage implements Message {
	...
	private  Map<Integer, Integer> snapshotSerialNumbers;
	...
	public BasicMessage(MessageType type, ServentInfo originalSenderInfo, ServentInfo receiverInfo) {
		...
		this.snapshotSerialNumbers = new HashMap<>(AppConfig.snapshotSerialNumbers);
	...
	public Map<Integer, Integer> getSnapshotSerialNumbers() {
		return snapshotSerialNumbers;
	}

	public void setSnapshotSerialNumbers(Map<Integer, Integer> snapshotSerialNumbers) {
		this.snapshotSerialNumbers = snapshotSerialNumbers;
	}
