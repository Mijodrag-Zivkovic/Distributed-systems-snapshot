...
public class AppConfig {
	...
	public static List<Integer> initiators = new ArrayList<>();
	...
	public static AtomicInteger snapshotCounter = new AtomicInteger(0);
	public static Map<Integer, Integer> snapshotSerialNumbers = new ConcurrentHashMap<>();
	...
	public static void readConfig(String configName){
		...
		for (int i = 0; i < serventCount; i++) {
			...
			boolean isInit = Boolean.parseBoolean(properties.getProperty("servent"+i+".init"));
			ServentInfo newInfo = new ServentInfo("localhost", i, serventPort, neighborList, isInit);
			if (isInit)
			{
				initiators.add(i);
				snapshotSerialNumbers.put(i, 0);
			}
