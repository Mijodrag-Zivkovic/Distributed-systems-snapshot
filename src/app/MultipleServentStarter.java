...
public class MultipleServentStarter {
	...
	public static void main(String[] args) {
		//startServentTest("ly_snapshot1");//Banetov osnovni test
		//startServentTest("ly_snapshot2");//2 razlicita pokrecu ne u isto vreme, 4 pa 0
		//startServentTest("ly_snapshot3");// node 4 pokrece snapshot jedan za drugim
		//startServentTest("ly_snapshot4");//node 0 i 4 pokrecu snap u isto vreme
		startServentTest("ly_snapshot5");//sistem sa 12 cvorova i 3 inita (0,6,11)
		//startServentTest("ly_snapshot6");//sistem sa 16 cvorova i 4 inita
	}
